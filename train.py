...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    nc = 10 if single_cls else int(data_dict['nc'])  # number of classes
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-quant.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/cifar10.yaml', help='dataset.yaml path')
